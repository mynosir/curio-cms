$(function() {
    config = {
        apiServer: document.domain=='dev.curio.com' ? 'http://dev.curio.com/adm/' : 'http://curio.kakaday.com/adm/',
        resServer: document.domain=='dev.curio.com' ? 'http://dev.curio.com/application/views/static/' : 'http://curio.kakaday.com/application/views/static/'
    };
    Utils = {
        // 请求数据公用方法
