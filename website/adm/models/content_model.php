...
class Content_model extends MY_Model {
    ...
    private $fields = 'id, title_en, title_tc, clazz_id, pic, descript_en, descript_tc, content_en, content_tc, author, create_time, update_time, create_userid, update_userid, pdf';
